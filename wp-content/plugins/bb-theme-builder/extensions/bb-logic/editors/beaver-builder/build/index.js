...
*/
var aa=__webpack_require__(1),l=__webpack_require__(13),B=__webpack_require__(4),C=__webpack_require__(3),ba=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ia=__webpack_require__(18),D=__webpack_require__(5);
...
var _renderer = __webpack_require__(257);
...
_reactDom2.default.render(_react2.default.createElement(_renderer2.default, null), document.getElementById('bb-logic-root'));
...
var RuleForm = BBLogic.components.RuleForm;
...
var Renderer = function (_Component) {
	...
	function Renderer(props) {
		...
		var _wpApiSettings = wpApiSettings,
		    root = _wpApiSettings.root,
		    nonce = _wpApiSettings.nonce;
	...
	_createClass(Renderer, [{
		...
		value: function componentDidMount() {
			jQuery('body').delegate('.fl-builder-logic-button', 'click', this.onLogicButtonClicked.bind(this));
		}
	}, {
		key: 'onLogicButtonClicked',
		value: function onLogicButtonClicked(e) {
		...
		value: function onSaveButtonClicked(rules) {
		...
		value: function render() {
			...
			return render ? _react2.default.createElement(RuleForm, {
				display: 'lightbox',
